...
Welcome to the MGBC-Toolkit, a tool for identifying the closest taxonomically and functionally related species between the human and mouse gut microbiotas, as well as the taxonomic locations of functions of interest between hosts. 

If you use the MGBC-Toolkit or the linked [MGBC genome catalogue](https://github.com/BenBeresfordJones/MGBC), please cite our paper: 
